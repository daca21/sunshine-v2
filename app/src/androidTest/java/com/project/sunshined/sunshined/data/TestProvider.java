 ...
 */
package com.project.sunshined.sunshined.data;
...
import com.project.sunshined.sunshined.data.WeatherContract.LocationEntry;
import com.project.sunshined.sunshined.data.WeatherContract.WeatherEntry;
...
//        deleteAllRecordsFromDB();  //until 4.13 ok
        deleteAllRecordsFromProvider();  //4.14 delete update content provider
    }
